...
--> statement-breakpoint
ALTER TABLE "jiuxuange_case_only"."case_progress" ADD CONSTRAINT "case_progress_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "jiuxuange_case_only"."users"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "jiuxuange_case_only"."progress_submissions" ADD CONSTRAINT "progress_submissions_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "jiuxuange_case_only"."users"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "case_progress_user_course_idx" ON "jiuxuange_case_only"."case_progress" USING btree ("user_id","course_id");--> statement-breakpoint
CREATE UNIQUE INDEX "progress_submissions_scope_key_idx" ON "jiuxuange_case_only"."progress_submissions" USING btree ("user_id","course_id","idempotency_key");--> statement-breakpoint
CREATE INDEX "progress_submissions_lookup_idx" ON "jiuxuange_case_only"."progress_submissions" USING btree ("user_id","course_id","case_id","created_at");